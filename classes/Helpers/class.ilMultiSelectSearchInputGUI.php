...
class ilMultiSelectSearchInputGUI extends ilMultiSelectInputGUI
{
	...
	public function __construct($title, $post_var){
		...
		$this->lng = $lng;
		$tpl->addJavaScript("./Customizing/global/plugins/Services/UIComponent/UserInterfaceHook/AdvancedTestStatistics/lib/select2.min.js");
		$tpl->addJavaScript("./Customizing/global/plugins/Services/UIComponent/UserInterfaceHook/AdvancedTestStatistics/lib/select2_locale_de.js");
		$tpl->addCss("./Customizing/global/plugins/Services/UIComponent/UserInterfaceHook/AdvancedTestStatistics/lib/select2.css");
		$this->setInputTemplate(new ilTemplate("tpl.multiple_select.html", true, true,"Customizing/global/plugins/Services/UIComponent/UserInterfaceHook/AdvancedTestStatistics"));
		$this->setWidth("308px");
	}
